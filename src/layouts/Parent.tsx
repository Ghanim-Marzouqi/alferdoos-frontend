...
import { parentRoutes } from '../routes/Routes';
...
const Parent: React.FC<Props> = ({ container }) => {
  ...
  const getRoutes = () => {
    const routes = flatArray(parentRoutes);
  ...
  const getDrawerItems = () => {
    return parentRoutes.map((item, i) => ({
      title: item.title,
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Switch>
          ...
          <Redirect from="/parent" to="/parent/student-registration" />
        </Switch>
      </main>
    </div>
  );
